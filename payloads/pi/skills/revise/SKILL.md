...
request's head rather than from `origin/main`. A cloud session working the pull
...
`${THUNDERSTORM_PLUGIN_ROOT}/scripts/push-verified.sh`, then post one reply comment listing each
