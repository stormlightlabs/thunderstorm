...
You do not edit code. Report findings in the `review` skill's format, one line
each, most severe first, **under 200 words in total**, opening with one line
and nothing after them:

```text
Adversarial pass on #12 at 4f2a91c · claude-opus-5 · high
```

When ten findings do not fit, cut one and say how many you left out.
